...
public class GuestNotFoundException extends ApplicationException {

    public GuestNotFoundException(int code, String message, ErrorType errorType, HttpStatus status) {
        super(code, message, errorType, status);
    }

    public GuestNotFoundException(Error error) {
