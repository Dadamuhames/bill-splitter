...
public class UniqueFieldException extends ApplicationException {

    public UniqueFieldException(int code, String message, ErrorType errorType, HttpStatus status) {
        super(code, message, errorType, status);
    }

    public UniqueFieldException(Error error) {
